...
@Schema(
        ...
        description = "Customer Order Histroy"
)
public class CustomerDashboardDTO {
    ...
    private List<OrdersWithRestaurantDTO> orders;
    ...
    public List<OrdersWithRestaurantDTO> getOrders() {
        return orders;
    }

    public void setOrders(List<OrdersWithRestaurantDTO> orders) {
        this.orders = orders;
    }
}
