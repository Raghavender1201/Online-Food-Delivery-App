...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDTO> handleCustomerAlreadyExistException(RestaurantAlreadyExistException ex, WebRequest request) {
    ...
    public ResponseEntity<ErrorResponseDTO> handleCustomerNotFoundException(ResourceNotFoundException ex, WebRequest request) {
        ErrorResponseDTO errorResponseDTO = new ErrorResponseDTO(
                request.getDescription(false),
                LocalDateTime.now(),
                ex.getMessage(),
    ...
    public ResponseEntity<ErrorResponseDTO> handleOrderNotFoundException(MenuItemAlreadyExistsException ex, WebRequest request) {
        ErrorResponseDTO errorResponseDTO = new ErrorResponseDTO(
                request.getDescription(false),
                LocalDateTime.now(),
                ex.getMessage(),
