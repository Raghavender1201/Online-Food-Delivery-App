...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDTO> handleCustomerAlreadyExistException(MenuItemNotFoundException ex, WebRequest request) {
    ...
    public ResponseEntity<ErrorResponseDTO> handleCustomerNotFoundException(RestaurantNotFoundException ex, WebRequest request) {
        ErrorResponseDTO errorResponseDTO = new ErrorResponseDTO(
                request.getDescription(false),
                LocalDateTime.now(),
                ex.getMessage(),
